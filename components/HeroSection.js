    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary">
      ...
      <div className="container mx-auto px-4 z-10 py-20">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">SA Tech DStv Installers</h1>
            <motion.p
              key={currentTagline}
          ...
          >
            ...
            <div className="relative h-[200px] rounded-lg overflow-hidden shadow-lg">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/dstv-satellite-dish.jpg-bQr7dtZAqrRvY46a2VQZuFrlBax0AF.jpeg"
                alt="DStv Equipment"
                fill
                className="object-cover"
              />
